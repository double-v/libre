  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <nav className="mb-8 text-sm text-gray-500 dark:text-gray-400" aria-label="Fil d'Ariane">
        ...
        <span className="text-gray-800 dark:text-gray-200">Informations légales</span>
      </nav>

      {children}

      {/* Footer links */}
      <div className="mt-16 flex flex-wrap items-center justify-center gap-4 border-t border-gray-200 pt-8 text-sm dark:border-gray-700">
