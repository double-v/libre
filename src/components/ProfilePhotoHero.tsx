  ...
  if (photos.length === 0) {
    return (
      <div
        ...
        className="flex aspect-[4/5] w-full flex-col items-center justify-center gap-3 rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 dark:border-gray-600 dark:bg-gray-800/50"
      >
        <svg
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">Aucune photo pour l’instant</p>
        {onAddClick && (
          <button
            type="button"
            onClick={onAddClick}
