...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed bottom-chrome left-4 z-40 h-10 w-10 rounded-full border border-gray-200 bg-white shadow-soft transition-colors hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
    >
      {dark ? (
        <svg
